...
# تنظیمات ربات
secret = "Rvi2EKo234234i5QH&lVeu"  # کلید امنیتی خود را اینجا قرار دهید
TOKEN = '7327927652:AAFEpz9tqZZt6vw5LJcRKfKRrpMoi-duRqI'
bot = telepot.Bot(TOKEN)
bot.setWebhook(f"https://karimmdk3.pythonanywhere.com/{secret}", max_connections=1)
